...
\subsubsection{\IfLanguageName{dutch}{Aantal lijnen code - Android}{Aantal lijnen code - Android}}
...
\subsubsection{\IfLanguageName{dutch}{Aantal lijnen code - iOS}{Aantal lijnen code - iOS}}
...
\subsubsection{\IfLanguageName{dutch}{Aantal lijnen code - KMM}{Aantal lijnen code - KMM}}
...
\subsubsection{\IfLanguageName{dutch}{Aantal lijnen code - conclusie}{Aantal lijnen code - conclusion}}
...
Grafiek \ref{G:tijd} toont de resultaten voor de drie applicaties:
\\ \\ 
\begin{tikzpicture}
    \begin{axis}[
...
\subsubsection{\IfLanguageName{dutch}{Compileersnelheid - Android}{Build speed - Android}}
\label{sec:M-test-compileersnelheid-android}
Tabel \ref{T:compileer-android} geeft een overzicht van de resultaten van het Android project geëvalueerd binnen Android Studio.
...
\subsubsection{\IfLanguageName{dutch}{Compileersnelheid - iOS}{Build speed - iOS}}
...
\subsubsection{\IfLanguageName{dutch}{Compileersnelheid - KMM}{Build speed - KMM}}
...
\subsubsection{\IfLanguageName{dutch}{Compileersnelheid - conclusie}{Build speed - conclusion}}
...
\subsubsection{\IfLanguageName{dutch}{Voetafdruk - Android}{Application sizes - Android}}
...
\subsubsection{\IfLanguageName{dutch}{Voetafdruk - iOS}{Application sizes - iOS}}
...
\subsubsection{\IfLanguageName{dutch}{Voetafdruk - KMM}{Application sizes - KMM}}
...
\subsubsection{\IfLanguageName{dutch}{Voetafdruk - conclusie}{Application sizes - conclusion}}
...
\subsection{\IfLanguageName{dutch}{Uitbreiding van de applicatie}{Expanding the application}}
